...
//        barLabel.isEnabled = false
    ...
    @IBAction func answerRequested(_ sender: Any) {
        if noIdea.currentTitle == "No idea :o" {
            ...
            let alert = UIAlertController(title: "Opinion", message: "Did you like that joke? Please say yes...", preferredStyle: .alert)
            ...
            alert.addAction(UIAlertAction(title: NSLocalizedString("No", comment: "Default action"), style: .destructive, handler: { _ in
